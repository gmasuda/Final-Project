...
char *descriptions[] = {" Dark and Scary ", " Spooky Lights ", " Bats and Rats ", " Large Pumpkins ", " Hot Dead Girls ",
 " Hot Dead Boys ", " Creeper Aw Man ", " Melons On Wall ", "ITEM: DIAMONDS", "Quirky Skeletons",
 "Steaming Muffins", "Levi Body Pillow", " Ponyo In A Jar ", " Smells Bad Ew ", " Smells Good ",
 " Box Maze ", " Slimy Walls ", " Hidden Wonders ", "Hypnotizing Feet", " Creeper Aw Man ",
 "Water To Drink" , " Toxic Gamers ", " Golf Clubs ", " Broken Skulls ", " Iron Bars ",
 " Mossy Stone ", " Cobwebs ", " Scary Noise ", " Kind Bars Yum " , "ITEM: MOLDYPIZZA", 
 " Eerie Echoes ", " Dust Bunnies ", " Shadowy Crips ", " Dust Mites ", " SECRET TUNNEL ",
 " GIRLBOSS DOOR ", " SLAY WINDOW ", "ITEM: ONE PIECE", "Itchy Straw Hat", " Sandy Beach " };
...
int createTxt(const char *folderName, int i, int j)
{
    ...
    fputs(content, fp);
    fprintf(fp, "%s", descriptions[counter]);
    counter++;
